...
function UploadModal({ onClose, onSuccess }) {
  ...
  const [meta, setMeta] = useState({ name: '', subject: SUBJECTS[1], description: '', tags: '', privacy: 'private' })
        ...
        {step === 'form' && (
          <form className="modal-body" onSubmit={handleSubmit}>
            <div className="selected-file">
              <div className="doc-ext" style={{ background: EXT_COLOR[file.ext] }}>{file.ext}</div>
              <div>
